...
import Shape1Image from "@/public/assets/footer/shape-1.svg";
import Shape3Image from "@/public/assets/footer/shape-3.svg";
    ...
    >
      <div className="container">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              <Link href="/" className="mb-6 inline-block max-w-[160px]">
                <Image src={LogoWhiteImage} alt="logo" className="w-auto h-auto max-w-full" />
              </Link>
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-white">{footerLinks[0].header}</h4>
              <ul>
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-white">{footerLinks[1].header}</h4>
              <ul>
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-white">{footerLinks[2].header}</h4>
              <ul>
          ...
          <div className="w-full px-4 md:w-2/3 lg:w-6/12 xl:w-3/12">
            <div className="mb-10 w-full">
              <h4 className="mb-9 text-lg font-semibold text-white">{footerLinks[3].header}</h4>
              <ul className="flex flex-col gap-8">
                {posts.slice(0, 2).map((blogPostEntry, i) => (
                  <li key={`post-${i}`}>
                    <Link
                      className="group flex items-center gap-[22px]"
                      href={`/blog/${blogPostEntry.metadata.slug}`}
                    >
                      <div className="overflow-hidden rounded max-w-[70px] w-full max-h-12 h-full">
                        <Image
                          className="w-full"
                      ...
                      <span className="max-w-[180px] text-gray-7 text-base group-hover:text-white">
                        {blogPostEntry.metadata.title.slice(0, 35)} ...
                      </span>
                    </Link>
                  </li>
                ))}
      ...
      <div>
        <span className="absolute left-0 top-0 z-[-1]">
          <Image className="w-auto h-auto" src={Shape1Image} alt="" />
        </span>

        <span className="absolute bottom-0 right-0 z-[-1]">
          <Image className="w-auto h-auto" src={Shape3Image} alt="" />
        </span>

export default function Contactsection() {
  return (
    <section id="contact" className="relative py-20 md:py-[120px]">
      <div className="absolute top-0 left-0 -z-[1] w-full dark:bg-dark h-full"></div>
              ...
              <div className="mb-12 flex flex-wrap justify-between lg:mb-0">
                ...
                <div className="mb-8 flex w-[330px] max-w-full">
                  ...
                  <div>
                    ...
                    <p className="text-base text-body-color dark:text-dark-6 mt-1">
            ...
            >
              ...
              <form>
                <div className="mb-[22px]">
                  <label
                    htmlFor="fullName"
                    className="block text-sm text-body-color dark:text-dark-6 mb-4"
                  >
                    Full Name*
                  </label>
                  <input
                ...
                <div className="mb-[30px]">
                  ...
                  <textarea
                    ...
                    className="bg-transparent w-full text-body-color dark:text-dark-6 placeholder:text-body-color/60 resize-none border-0 border-b border-[#f1f1f1] dark:border-dark-3 pb-3 focus:border-primary focus:outline-none"
                  ></textarea>
                </div>
                <div className="mb-0">
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center rounded-md bg-primary py-3 px-10 text-base font-medium text-white transition duration-300 ease-in-out hover:bg-blue-dark"
                  >
                    Send
                  </button>
                </div>

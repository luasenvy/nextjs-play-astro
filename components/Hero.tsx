...
import HeroImage from "@/public/assets/hero/hero-image.jpg";
          ...
          <div className="w-full px-4">
            ...
            >
              <h1 className="mb-6 text-3xl font-bold leading-snug text-white sm:text-4xl sm:leading-snug lg:text-5xl lg:leading-[1.2]">
                Free Astro Template and Starter for SaaS, Startup, and App Sites
              </h1>
              <p className="mx-auto mb-9 max-w-[600px] font-medium text-base text-white sm:text-lg sm:leading-[1.44]">
                A fantastic free and open-source Astro template, built for startups, SaaS companies,
                apps, businesses, and more. Comes with all essential pages, sections, components and
                fully-functional blog.
              </p>
              <ul className="mb-10 flex gap-5 flex-wrap items-center justify-center">
                <li>
                  <Link
                    href="https://github.com/TailGrids/play-astro/archive/refs/heads/main.zip"
              ...
              <div
                className="wow fadeInUp text-center flex items-center justify-center gap-4"
                data-wow-delay=".3s"
              >
                <Link
                  href="https://github.com/uideck/play-bootstrap/"
                  className="text-white/60 hover:text-white duration-300 ease-in-out"
                  target="_blank"
                >
                  <svg
                    className="fill-current"
            ...
            <div className="wow fadeInUp relative z-10 mx-auto max-w-[845px]" data-wow-delay=".25s">
              <div className="mt-16">
                <Image
                  src={HeroImage}
                  alt="hero"
                  className="w-auto h-auto mx-auto max-w-full rounded-t-xl rounded-tr-xl"
                />
              </div>

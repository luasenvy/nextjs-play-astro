...
export default function Formbox({ children }: React.HTMLAttributes<HTMLElement>) {
  return (
            ...
            >
              <div className="mb-10 text-center">
                <Link href="/" className="mx-auto inline-block max-w-[160px]">
                  <Image src={LogoImage} alt="logo" className="dark:hidden" />
                  <Image src={LogoWhiteImage} alt="logo" className="hidden dark:block" />
                </Link>
              </div>

...
export default function BlogViewer() {
  ...
  const entry = useMemo(() => posts.find(({ metadata }) => slug === metadata.slug), [slug]);
            ...
            <div className="w-full px-4">
              ...
              >
                <Image
                  width={1300}
                  height={500}
                  src={entry.metadata.bigImg.src}
                  alt={entry.metadata.bigImg.alt}
                  ...
                  <div className="flex flex-wrap items-center p-4 pb-4 sm:px-8">
                    <div className="mb-4 mr-5 flex items-center md:mr-10">
                      <div className="mr-4 h-10 w-10 overflow-hidden rounded-full">
                        <Image
                          width={40}
                          height={40}
                          src={entry.metadata.authorImg.src}
                          alt={entry.metadata.authorImg.alt}
                          className="w-full"
                        />
                      </div>
                    ...
                    <div className="mb-4 flex items-center">
                      <p className="mr-5 flex items-center text-sm font-medium text-white md:mr-6">
                        ...
                        {new Date(entry.metadata.publishDate).toDateString()}
                      </p>
              ...
              <div className="-mx-4 flex flex-wrap">
                <div className="w-full px-4 lg:w-8/12">
                  <div>
                    ...
                    <p
                      className="wow fadeInUp mb-6 text-base text-body-color dark:text-dark-6"
                      data-wow-delay=".1s"
                    >
                      {entry.metadata.postDetails.paraOne}
                    </p>
                    <p
                      className="wow fadeInUp mb-8 text-base text-body-color dark:text-dark-6"
                      data-wow-delay=".1s"
                    >
                      {entry.metadata.postDetails.paraTwo}
                    </p>
                    <h2
                      className="wow fadeInUp mb-6 text-2xl font-bold text-dark dark:text-white sm:leading-[40px] sm:text-[28px]"
                      data-wow-delay=".1s"
                    >
                      {entry.metadata.postDetails.title}
                    </h2>
                    <p
                      className="wow fadeInUp mb-10 text-base text-body-color dark:text-dark-6"
                      data-wow-delay=".1s"
                    >
                      {entry.metadata.postDetails.paraThree}
                    </p>
                    <div
                      className="wow fadeInUp relative z-10 mb-10 overflow-hidden rounded-[5px] bg-primary/5 py-8 px-6 text-center sm:p-10 md:px-[60px]"
                      data-wow-delay=".1s"
                    >
                    ...
                    <h3
                      className="wow fadeInUp mb-6 text-2xl font-semibold text-dark dark:text-white sm:leading-[40px] sm:text-[28px]"
                      data-wow-delay=".1s"
                    >
                      {entry.metadata.postDetails.titleTwo}
                    </h3>
                    ...
                    <p
                      ...
                      data-wow-delay=".1s"
                    >
                      {entry.metadata.postDetails.paraFour}
                    </p>
                    <p
                      className="wow fadeInUp mb-10 text-base text-body-color dark:text-dark-6"
                      data-wow-delay=".1s"
                    >
                      {entry.metadata.postDetails.paraFive}
                    </p>

                    <div className="-mx-4 mb-12 flex flex-wrap items-center">
                      <div className="w-full px-4 md:w-1/2">
                        <div
                          className="wow fadeInUp mb-8 flex flex-wrap items-center gap-3 md:mb-0"
                          data-wow-delay=".1s"
                        >
                          {entry.metadata.tags.map((tag, i) => (
                            <Link
                              key={`tag-${i}`}
                              href="#"
                              className="cursor-none block rounded-md bg-primary/[0.08] py-[5px] px-[14px] text-base text-dark dark:text-white hover:bg-primary hover:text-white"
                            >
                              {tag}
                            </Link>
                          ))}
                ...
                <div className="w-full px-4 lg:w-4/12">
                  <div>
                    ...
                    <div
                      ...
                      data-wow-delay=".1s"
                    >
                      <Image src={BannerAdImage} alt="image" className="w-full" />
                    </div>
                  </div>
                </div>
              </div>
